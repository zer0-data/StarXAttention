...
from .starx_flash_attn import starx_flash_attn_func, starx_flash_attn_varlen_func
...
def _flash_attention_forward(
    ...
    if attention_mask is not None:
        ...
        attn_varlen_func = starx_flash_attn_varlen_func 
